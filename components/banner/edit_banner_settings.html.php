...
<form action="<?php echo $bannerEditURL; ?>" method="post">
    ...
    <?php echo LABEL_SITE_URL; ?> <input type="text" name="site_url" value="<?php echo htmlspecialchars($site_url); ?>" width="120" maxlength="255" /><br/>
    <?php echo LABEL_BACKGROUND_IMAGE; ?><input type="text" name="background_image" value="<?php echo htmlspecialchars($background_image); ?>" width="120" maxlength="255" /><br/>
    
    <?php echo LABEL_PRICE_TEXT; ?><input type="text" name="price_text" value="<?php echo htmlspecialchars($price_text); ?>" width="120" maxlength="255" /><br/>
    <?php echo LABEL_TIME_TEXT; ?><input type="text" name="time_text" value="<?php echo htmlspecialchars($time_text); ?>" width="120" maxlength="255" /><br/>
